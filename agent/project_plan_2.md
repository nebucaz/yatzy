...
## Story 1.6: Mark skipped result cells
Status: ✅ Completed

### Acceptance Criteria
- When a result cell is marked a skipped, it should not be highlighted. It should be obvious, that it has been marked as skipped
- The player column with should be at least the with of the player name. It must not exceed 150px
- When clearing a scoreboard, the players should be retained

## Story 1.7: Add a Summary row  
Status: ✅ Completed

### Acceptance Criteria
- Add a summary row between "sixes" and "bonus"
- Automatically calculate and show the sum of the top 6 rows for player information

### Technical Implementation
- The additinal row only is informative for the player
